//+------------------------------------------------------------------+
//|                   STRAT-20260903-3WHITESOLDIERS-H4-v1.1.mq5      |
//|               QUANT AGENTIC SWARM (QAS) — MQL5 POO               |
//|                    Autor: QRT Solutions                          |
//|  Tesis: Patron de velas Three White Soldiers (Nison), version    |
//|  SIMPLIFICADA de diagnostico: solo geometria basica del patron,  |
//|  filtros de calidad/tendencia/regimen opcionales (off por        |
//|  defecto) para maximizar la frecuencia de señales observables.  |
//|  Estrategia solo-largo (long-only). Generico para cualquier      |
//|  simbolo bursatil o CFD.                                         |
//+------------------------------------------------------------------+
#property copyright   "QRT Solutions"
#property link        "https://github.com/quant-agentic-swarm"
#property version     "1.10"
#property description "STRAT-20260903-3WHITESOLDIERS-H4-v1.1"
...
input bool     InpUseQualityFilters = false;   // Exigir Cuerpo/Mecha (false = solo vela alcista simple)

input group "1b. Filtro de Tendencia Previa (Opcional)"
input bool     InpUseTrendFilter    = false;   // Activar Filtro de Tendencia Bajista Previa
...
input group "2. Regimen de Volatilidad MTF (D1 - Lopez de Prado) - Opcional"
input bool     InpUseRegime         = false;   // Activar Filtro Z-Score MTF
...
input ulong    InpMagicNumber       = 20260906; // Magic Number Unico
input string   InpStrategyID        = "STRAT-20260903-3WHITESOLDIERS-H4-v1.1";
