# STRAT-20260902-ORB_MOM-M5-v1.0

Autoría: QRT Solutions. Extensión de investigación y backtesting.

## Hipótesis

Se define el Rango de Apertura (OR) como el maximo y minimo de las primeras N_or=3 velas M5 (15 minutos) tras la apertura de la sesion regular de EEUU (13:30 UTC). En cada vela M5 posterior al OR, se calcula ROC_i = (Close_i - Close_i-1) / Close_i-1. Si tres valores consecutivos de ROC son crecientes y del mismo signo (ROC_i > ROC_i-1 > ROC_i-2, con ROC_i > 0 para largos o ROC_i < 0 para cortos) Y el Close de la vela actual rompe el extremo del OR (Close > OR_high para largos, Close < OR_low para cortos), se genera la señal de entrada.

Resultado propuesto: Continuacion direccional del precio durante el resto de la sesion regular, extendiendo el rango en la direccion de la ruptura hasta tocar la Barrera de Take Profit o el cierre de sesion.
...
| Evidencia | Estado |
|---|---|
| Fuente MQL5 | [Disponible](STRAT-20260902-ORB_MOM-M5-v1.0.mq5) |
| Contrato | [Esquema v2](STRAT-20260902-ORB_MOM-M5-v1.0_specification.json) |
